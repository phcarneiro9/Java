...
// Listar todos os dados do vetor de reais em ordem decrescente (muda a ordem no vetor)
...
System.out.println("Qual é o indice do valor 10 no vertor de reais? " + Arrays.binarySearch(vetorReais, 10 ));
